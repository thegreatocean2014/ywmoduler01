declare global {
  ...
  const cachedEventHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/cache').cachedEventHandler
  const cachedFunction: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/cache').cachedFunction
  ...
  const defineCachedEventHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/cache').defineCachedEventHandler
  const defineCachedFunction: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/cache').defineCachedFunction
  ...
  const defineNitroErrorHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/error/utils').defineNitroErrorHandler
  const defineNitroPlugin: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/plugin').defineNitroPlugin
  ...
  const defineRenderHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/renderer').defineRenderHandler
  ...
  const defineRouteMeta: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/meta').defineRouteMeta
  const defineTask: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/task').defineTask
  ...
  const getRouteRules: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/route-rules').getRouteRules
  ...
  const nitroPlugin: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  ...
  const runTask: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/task').runTask
  ...
  const useAppConfig: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/config').useAppConfig
  const useBase: typeof import('../../../node_modules/.pnpm/h3@1.15.11/node_modules/h3').useBase
  const useEvent: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/context').useEvent
  const useNitroApp: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/app').useNitroApp
  ...
  const useRuntimeConfig: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/config').useRuntimeConfig
  const useSession: typeof import('../../../node_modules/.pnpm/h3@1.15.11/node_modules/h3').useSession
  const useStorage: typeof import('../../../node_modules/.pnpm/nitropack@2.13.4_oxc-parser@0.130.0_rolldown@1.0.2/node_modules/nitropack/dist/runtime/internal/storage').useStorage
...
export { clearRefreshTokenCookie, setRefreshTokenCookie, getRefreshTokenFromCookie } from 'D:/workspace/rust/tauri/OceanModulerTauri/apps/backend-mock/utils/cookie-utils';
export { generateAccessToken, generateRefreshToken, verifyAccessToken, verifyRefreshToken } from 'D:/workspace/rust/tauri/OceanModulerTauri/apps/backend-mock/utils/jwt-utils';
export { MOCK_USERS, MOCK_CODES, MOCK_MENUS, MOCK_MENU_LIST, getMenuIds, TIME_ZONE_OPTIONS } from 'D:/workspace/rust/tauri/OceanModulerTauri/apps/backend-mock/utils/mock-data';
export { useResponseSuccess, usePageResponseSuccess, useResponseError, forbiddenResponse, unAuthorizedResponse, sleep, pagination } from 'D:/workspace/rust/tauri/OceanModulerTauri/apps/backend-mock/utils/response';
export { setTimezone, getTimezone } from 'D:/workspace/rust/tauri/OceanModulerTauri/apps/backend-mock/utils/timezone-utils';